...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9750&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/korean_lunar_calendar-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `korean_lunar_calendar` can be installed with:

```
conda install korean_lunar_calendar
```

It is possible to list all of the versions of `korean_lunar_calendar` available on your platform with:
